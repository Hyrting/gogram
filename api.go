...
type API interface {
	...
	SendAfter(d time.Duration, to Recipient, what interface{}, opts ...interface{}) (*Message, error)
	SendAfterSignal(Chan chan string, to Recipient, opts ...interface{}) (*Message, error)
