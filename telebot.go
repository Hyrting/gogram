// Package gogram is a framework for Telegram bots.
//
// Example:
//
//	package main
...
//
//	func main() {
//		b, err := gogram.NewBot(gogram.Settings{
//			Token:  "...",
//			Poller: &gogram.LongPoller{Timeout: 10 * time.Second},
//		})
//		if err != nil {
//			return
//		}
...
var (
	ErrBadRecipient    = errors.New("gogram: recipient is nil")
	ErrUnsupportedWhat = errors.New("gogram: unsupported what argument")
	ErrCouldNotUpdate  = errors.New("gogram: could not fetch new updates")
	ErrTrueResult      = errors.New("gogram: result is True")
	ErrBadContext      = errors.New("gogram: context does not contain message")
)
