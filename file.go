...
// with something. NewFile() returning File makes it a one-liner.
//
//	photo := &gogram.Photo{File: gogram.FromURL("https://site.com/picture.jpg")}
...
// with something. NewFile() returning File makes it a one-liner.
//
//	photo := &gogram.Photo{File: gogram.FromReader(bytes.NewReader(...))}
